...
#if !defined(blue_Sync_ctrl_reg__REMOVED)

static blue_BACKUP_STRUCT  blue_backup = {0u};
...
{
    blue_backup.controlState = blue_Control;
}
...
{
     blue_Control = blue_backup.controlState;
}
