...
*
*  A_DM_STRONG     Strong Drive 
*  A_DM_OD_HI      Open Drain, Drives High 
*  A_DM_OD_LO      Open Drain, Drives Low 
*  A_DM_RES_UP     Resistive Pull Up 
*  A_DM_RES_DWN    Resistive Pull Down 
*  A_DM_RES_UPDWN  Resistive Pull Up/Down 
*  A_DM_DIG_HIZ    High Impedance Digital 
*  A_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
