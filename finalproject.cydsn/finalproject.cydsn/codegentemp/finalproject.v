...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyControlReg_v1_80"
`include "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyControlReg_v1_80\CyControlReg_v1_80.v"
`endif
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_Timer_v2_70"
`include "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_Timer_v2_70\B_Timer_v2_70.v"
`endif
...
// emFile_v1_20(Max_SPI_Frequency=4000, NumberSDCards=1, WP0_En=false, WP1_En=false, WP2_En=false, WP3_En=false, CY_COMPONENT_NAME=emFile_v1_20, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=emFile_1, CY_INSTANCE_SHORT_NAME=emFile_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1 SP2, INSTANCE_NAME=emFile_1, )
module emFile_v1_20_5 ;
	...
	cy_clock_v1_0
		#(.id("b60e742b-80ab-4d2d-974c-b058b3caa54f/5ed615c6-e1f0-40ed-8816-f906ef67d531"),
...
module top ;
    ...
    CyControlReg_v1_80 blue2 (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam blue2.Bit0Mode = 0;
    defparam blue2.Bit1Mode = 0;
    defparam blue2.Bit2Mode = 0;
    defparam blue2.Bit3Mode = 0;
    defparam blue2.Bit4Mode = 0;
    defparam blue2.Bit5Mode = 0;
    defparam blue2.Bit6Mode = 0;
    defparam blue2.Bit7Mode = 0;
    defparam blue2.BitValue = 0;
    defparam blue2.BusDisplay = 0;
    defparam blue2.ExtrReset = 0;
    defparam blue2.NumOutputs = 1;
    ...
    CyControlReg_v1_80 red2 (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam red2.Bit0Mode = 0;
    defparam red2.Bit1Mode = 0;
    defparam red2.Bit2Mode = 0;
    defparam red2.Bit3Mode = 0;
    defparam red2.Bit4Mode = 0;
    defparam red2.Bit5Mode = 0;
    defparam red2.Bit6Mode = 0;
    defparam red2.Bit7Mode = 0;
    defparam red2.BitValue = 0;
    defparam red2.BusDisplay = 0;
    defparam red2.ExtrReset = 0;
    defparam red2.NumOutputs = 1;

    CyControlReg_v1_80 green2 (
        .control_1(Net_184),
        .control_2(Net_185),
        .control_3(Net_186),
        .control_0(Net_187),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam green2.Bit0Mode = 0;
    defparam green2.Bit1Mode = 0;
    defparam green2.Bit2Mode = 0;
    defparam green2.Bit3Mode = 0;
    defparam green2.Bit4Mode = 0;
    defparam green2.Bit5Mode = 0;
    defparam green2.Bit6Mode = 0;
    defparam green2.Bit7Mode = 0;
    defparam green2.BitValue = 0;
    defparam green2.BusDisplay = 0;
    defparam green2.ExtrReset = 0;
    defparam green2.NumOutputs = 1;

    CyControlReg_v1_80 red (
        .control_1(Net_41),
        .control_2(Net_42),
        .control_3(Net_43),
        .control_0(Net_44),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam red.Bit0Mode = 0;
    defparam red.Bit1Mode = 0;
    defparam red.Bit2Mode = 0;
    defparam red.Bit3Mode = 0;
    defparam red.Bit4Mode = 0;
    defparam red.Bit5Mode = 0;
    defparam red.Bit6Mode = 0;
    defparam red.Bit7Mode = 0;
    defparam red.BitValue = 0;
    defparam red.BusDisplay = 0;
    defparam red.ExtrReset = 0;
    defparam red.NumOutputs = 1;
	...
	wire [0:0] tmpOE__G1_net;
	wire [0:0] tmpFB_0__G1_net;
	wire [0:0] tmpIO_0__G1_net;
	wire [0:0] tmpINTERRUPT_0__G1_net;
	electrical [0:0] tmpSIOVREF__G1_net;
	...
	cy_psoc3_pins_v1_10
		...
		G1
		 (.oe(tmpOE__G1_net),
		  .y({Net_51}),
		  .fb({tmpFB_0__G1_net[0:0]}),
		  .io({tmpIO_0__G1_net[0:0]}),
		  .siovref(tmpSIOVREF__G1_net),
		  .interrupt({tmpINTERRUPT_0__G1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__G1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__LAT_net;
	wire [0:0] tmpFB_0__LAT_net;
	wire [0:0] tmpIO_0__LAT_net;
	wire [0:0] tmpINTERRUPT_0__LAT_net;
	electrical [0:0] tmpSIOVREF__LAT_net;
	...
	cy_psoc3_pins_v1_10
		...
		LAT
		 (.oe(tmpOE__LAT_net),
		  .y({Net_57}),
		  .fb({tmpFB_0__LAT_net[0:0]}),
		  .io({tmpIO_0__LAT_net[0:0]}),
		  .siovref(tmpSIOVREF__LAT_net),
		  .interrupt({tmpINTERRUPT_0__LAT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LAT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 clk (
        .control_1(Net_58),
        .control_2(Net_59),
        .control_3(Net_60),
        .control_0(Net_56),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam clk.Bit0Mode = 0;
    defparam clk.Bit1Mode = 0;
    defparam clk.Bit2Mode = 0;
    defparam clk.Bit3Mode = 0;
    defparam clk.Bit4Mode = 0;
    defparam clk.Bit5Mode = 0;
    defparam clk.Bit6Mode = 0;
    defparam clk.Bit7Mode = 0;
    defparam clk.BitValue = 0;
    defparam clk.BusDisplay = 0;
    defparam clk.ExtrReset = 0;
    defparam clk.NumOutputs = 1;

	wire [0:0] tmpOE__OEpin_net;
	wire [0:0] tmpFB_0__OEpin_net;
	wire [0:0] tmpIO_0__OEpin_net;
	wire [0:0] tmpINTERRUPT_0__OEpin_net;
	electrical [0:0] tmpSIOVREF__OEpin_net;
	...
	cy_psoc3_pins_v1_10
		...
		OEpin
		 (.oe(tmpOE__OEpin_net),
		  .y({Net_67}),
		  .fb({tmpFB_0__OEpin_net[0:0]}),
		  .io({tmpIO_0__OEpin_net[0:0]}),
		  .siovref(tmpSIOVREF__OEpin_net),
		  .interrupt({tmpINTERRUPT_0__OEpin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OEpin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 CBA (
        .control_1(Net_54),
        .control_2(Net_55),
        .control_3(Net_68),
        .control_0(Net_53),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam CBA.Bit0Mode = 0;
    defparam CBA.Bit1Mode = 0;
    defparam CBA.Bit2Mode = 0;
    defparam CBA.Bit3Mode = 0;
    defparam CBA.Bit4Mode = 0;
    defparam CBA.Bit5Mode = 0;
    defparam CBA.Bit6Mode = 0;
    defparam CBA.Bit7Mode = 0;
    defparam CBA.BitValue = 0;
    defparam CBA.BusDisplay = 0;
    defparam CBA.ExtrReset = 0;
    defparam CBA.NumOutputs = 3;

    CyControlReg_v1_80 Latch (
        .control_1(Net_75),
        .control_2(Net_76),
        .control_3(Net_77),
        .control_0(Net_57),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Latch.Bit0Mode = 0;
    defparam Latch.Bit1Mode = 0;
    defparam Latch.Bit2Mode = 0;
    defparam Latch.Bit3Mode = 0;
    defparam Latch.Bit4Mode = 0;
    defparam Latch.Bit5Mode = 0;
    defparam Latch.Bit6Mode = 0;
    defparam Latch.Bit7Mode = 0;
    defparam Latch.BitValue = 0;
    defparam Latch.BusDisplay = 0;
    defparam Latch.ExtrReset = 0;
    defparam Latch.NumOutputs = 1;

    CyControlReg_v1_80 OE (
        .control_1(Net_84),
        .control_2(Net_85),
        .control_3(Net_86),
        .control_0(Net_67),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam OE.Bit0Mode = 0;
    defparam OE.Bit1Mode = 0;
    defparam OE.Bit2Mode = 0;
    defparam OE.Bit3Mode = 0;
    defparam OE.Bit4Mode = 0;
    defparam OE.Bit5Mode = 0;
    defparam OE.Bit6Mode = 0;
    defparam OE.Bit7Mode = 0;
    defparam OE.BitValue = 0;
    defparam OE.BusDisplay = 0;
    defparam OE.ExtrReset = 0;
    defparam OE.NumOutputs = 1;

    CyControlReg_v1_80 blue (
        .control_1(Net_93),
        .control_2(Net_94),
        .control_3(Net_95),
        .control_0(Net_52),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam blue.Bit0Mode = 0;
    defparam blue.Bit1Mode = 0;
    defparam blue.Bit2Mode = 0;
    defparam blue.Bit3Mode = 0;
    defparam blue.Bit4Mode = 0;
    defparam blue.Bit5Mode = 0;
    defparam blue.Bit6Mode = 0;
    defparam blue.Bit7Mode = 0;
    defparam blue.BitValue = 0;
    defparam blue.BusDisplay = 0;
    defparam blue.ExtrReset = 0;
    defparam blue.NumOutputs = 1;

    CyControlReg_v1_80 green (
        .control_1(Net_102),
        .control_2(Net_103),
        .control_3(Net_104),
        .control_0(Net_51),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam green.Bit0Mode = 0;
    defparam green.Bit1Mode = 0;
    defparam green.Bit2Mode = 0;
    defparam green.Bit3Mode = 0;
    defparam green.Bit4Mode = 0;
    defparam green.Bit5Mode = 0;
    defparam green.Bit6Mode = 0;
    defparam green.Bit7Mode = 0;
    defparam green.BitValue = 0;
    defparam green.BusDisplay = 0;
    defparam green.ExtrReset = 0;
    defparam green.NumOutputs = 1;
	...
	wire [0:0] tmpOE__G2_net;
	wire [0:0] tmpFB_0__G2_net;
	wire [0:0] tmpIO_0__G2_net;
	wire [0:0] tmpINTERRUPT_0__G2_net;
	electrical [0:0] tmpSIOVREF__G2_net;
	...
	cy_psoc3_pins_v1_10
		...
		G2
		 (.oe(tmpOE__G2_net),
		  .y({Net_187}),
		  .fb({tmpFB_0__G2_net[0:0]}),
		  .io({tmpIO_0__G2_net[0:0]}),
		  .siovref(tmpSIOVREF__G2_net),
		  .interrupt({tmpINTERRUPT_0__G2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__G2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_40_3 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_306),
        .tx_interrupt(Net_318),
        .rx_interrupt(Net_319),
        .tx_data(Net_320),
        .tx_clk(Net_321),
        .rx_data(Net_322),
        .rx_clk(Net_323));
