...
*
*  C_DM_STRONG     Strong Drive 
*  C_DM_OD_HI      Open Drain, Drives High 
*  C_DM_OD_LO      Open Drain, Drives Low 
*  C_DM_RES_UP     Resistive Pull Up 
*  C_DM_RES_DWN    Resistive Pull Down 
*  C_DM_RES_UPDWN  Resistive Pull Up/Down 
*  C_DM_DIG_HIZ    High Impedance Digital 
*  C_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
